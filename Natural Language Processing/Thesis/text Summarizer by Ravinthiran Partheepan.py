...
summarizer_2 = TextRankSummarizer()

from gensim.summarization import summarize
from NLTK_Package_by_Ravinthiran_Partheepan import nltk_summarizer
...
window = Tk()
window.title("Summarizer by Ravinthiran Partheepan")
...
label1 = Label(tab1, text= 'Summarizer by Ravinthiran Partheepan',padx=5, pady=5)
...
button5=Button(tab4,text="NLTK",command=use_nltk, width=12,bg='#03A9F4',fg='#fff')
...
about_label = Label(tab5,text="Text Summarizer NLP Homework by  \n Ravinthiran Partheepan",pady=5,padx=5)
